...
///
/// Serialized: the adoption tests assert on the process-global
/// `BackgroundSyncService.lifecycleLock`.
@Suite("Scene activation adopts a running engine (#60)", .serialized)
